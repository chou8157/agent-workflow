...
def write_artifact(project: Path, artifact_id: str, artifact_type: str, audience: str, period: str, content: str) -> Path:
    ...
    metadata["source_snapshot"] = {"content_sha256": sha256(target)}
